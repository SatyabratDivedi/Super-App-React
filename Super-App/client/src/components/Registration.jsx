...
const Registration = () => {
    ...
    const errorRefs = Array(4).fill().map(() => useRef());
    const borderRefs = Array(3).fill().map(() => useRef());
            ...
            <div className='mainHeader'>
...

                {
                    isSignIn ?
                        ...
                        (
                            <div ref={signUpFormRef} className=" absolute right-0 right z-0  bottom-[10%] duration-[1500ms]">
                                <div className='w-[50%] text-center'>
                                    ...
                                    <div>
                                        <form onSubmit={submitHandle} className='form'>
                                            ...
                                            <span ref={errorRefs[2]} className=' hidden text-start text-[.7rem] text-red-500  max-h-3'>Field is required</span>
                                            ...
                                            <span ref={errorRefs[3]} className=' hidden mb-3 text-start text-[.7rem] text-red-500 '>Check this box if you want to proceed</span>
                                            <button className='bg-[#72DB73] rounded-2xl mb-3 font-roboto font-bold p-[.2rem] active:scale-95 duration-200'>Sing Up</button>
                                        </form>
                                        <div className='font-roboto text-[.7rem] text-start'>By clicking on Sign up. you agree to Superapp <span className=' text-[#72DB73] cursor-pointer'>Terms and Conditions of Use</span></div>
                                        <div className='font-roboto mt-2 text-[.7rem] text-start'>To learn more about how Superapp collects, uses, shares and protects your personal data please head Superapp <span className=' cursor-pointer text-[#72DB73]'>Privacy Policy</span></div>
                                    </div>
                                    <div className=' text-start border-b borderw w-[80%] mt-4'> Already have an account <span onClick={signInSlideHandle} className=' font-roboto text-[#72DB73] cursor-pointer'>Sigh In</span> </div>
                                </div>
                            </div>
                        )
                }
